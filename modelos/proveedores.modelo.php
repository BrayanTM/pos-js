...
class ProveedoresModelo
{
    ...
    static public function mdlObtenerProveedores($post)
    {
        ...
        $column = ["id", "tipo_documento", "nit", "razon_social", "direccion", "telefono", "estado"];
        ...
        if (isset($post["search"]["value"])) {
            $query .= ' WHERE p.razon_social like "%' . $post["search"]["value"] . '%"
                        ...
                        or p.nit like "%' . $post["search"]["value"] . '%"
                        or p.direccion like "%' . $post["search"]["value"] . '%"
    ...
    static public function mdlRegistrarProveedor($proveedor){
        ...
        try {
            ...
            $stmt = $dbh->prepare("INSERT INTO proveedores(id_tipo_documento,nit,razon_social,direccion,telefono,estado)
                                    VALUES(?,?,UPPER(?),?,?,?)");
    ...
    static public function mdlValidarNit($id_proveedor, $nit)
    {
