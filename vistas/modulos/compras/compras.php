                                        ...
                                        <div class="card-body py-2">
                                            ...
                                            <div class="row fw-bold">
                                                ...
                                                <div class="col-12 text-danger">
                                                    <span>DESCUENTO</span>
                                                    <span class="float-right" id="resumen_total_descuento">Q 0.00</span>
                                                    <hr class="m-1" />
                                                </div>
                        ...
                        <table id="tbl_productos" class="table table-striped w-100 shadow border border-secondary">
                            <thead class="bg-main">
                                <tr style="font-size: 15px;">
                                    ...
                                    <th>Producto</th> <!-- 6 -->
                                    <th>Imagen</th> <!-- 7 -->
                                    <th>Id Tipo Afec. IVA</th> <!-- 8 -->
                                    <th>Tipo Afec. IVA</th> <!-- 9 -->
                                    <th>Id Unidad Medida</th> <!-- 10 -->
                                    <th>Unidad Medida</th> <!-- 11 -->
                                    <th>Costo Unit.</th> <!-- 12 -->
                                    <th>Precio C/IVA</th> <!-- 13 -->
                                    <th>Precio S/IVA</th> <!-- 14 -->
                                    <th>Precio Mayor C/IVA</th> <!-- 15 -->
                                    <th>Precio Mayor S/IVA</th> <!-- 16 -->
                                    <th>Precio Oferta C/IVA</th> <!-- 17 -->
                                    <th>Precio Oferta S/IVA</th> <!-- 18 -->
                                    <th>Stock</th> <!-- 19 -->
                                    <th>Min. Stock</th> <!-- 20 -->
                                    <th>Ventas</th> <!-- 21 -->
                                    <th>Costo Total</th> <!-- 22 -->
                                    <th>Fecha Creación</th> <!-- 23 -->
                                    <th>Fecha Actualización</th> <!-- 24 -->
                                    <th>Estado</th> <!-- 25 -->
                                </tr>
                            </thead>
                ...
                <form id="frm-datos-producto" class="needs-validation" novalidate>
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-6 mb-2">
                            ...
                            <select class="form-select" id="id_tipo_afectacion_iva" name="id_tipo_afectacion_iva" aria-label="Floating label select example" required>
                            </select>
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6 mb-2">
                                    ...
                                    <input type="number" min="0" step="0.01" placeholder="Ingrese Precio sin IVA" class="form-control form-control-sm" id="precio_unitario_sin_iva" name="precio_unitario_sin_iva" aria-label="Small" aria-describedby="inputGroup-sizing-sm" readonly>
                                </div>
                                ...
                                <div class="col-12 col-lg-6 mb-2">
                                    ...
                                    <input type="number" min="0" step="0.01" placeholder="Ingrese Precio x Mayor sin IVA" class="form-control form-control-sm" id="precio_unitario_mayor_sin_iva" name="precio_unitario_mayor_sin_iva" aria-label="Small" aria-describedby="inputGroup-sizing-sm" readonly>
                                </div>
                                ...
                                <div class="col-12 col-lg-6 mb-2">
                                    ...
                                    <input type="number" min="0" step="0.01" placeholder="Ingrese precio oferta sin IVA" class="form-control form-control-sm" id="precio_unitario_oferta_sin_iva" name="precio_unitario_oferta_sin_iva" aria-label="Small" aria-describedby="inputGroup-sizing-sm" readonly>
                                </div>

                                <!-- MINIMO STOCK -->
                                <div class="col-12 col-lg-12">
                                    <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-boxes mr-1 my-text-color"></i>Stock Mínimo</label>
                                    <input type="number" min="0" step="0.01" placeholder="Ingrese el Stock Mínimo" class="form-control form-control-sm" id="minimo_stock" name="minimo_stock" aria-label="Small" aria-describedby="inputGroup-sizing-sm">
                                </div>
            ...
            <div class="modal-body">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-12 col-md-5 col-lg-3 mb-1">
                        <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-id-card mr-1 my-text-color"></i> Nit</label>
                        <input type="text" style="border-radius: 20px;" class="form-control form-control-sm" id="mostrar_nit" aria-label="Small" aria-describedby="inputGroup-sizing-sm" disabled>
                    </div>
                        ...
                        <form id="frm-datos-proveedores" class="needs-validation-proveedores" novalidate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-3 mb-2">
                                    ...
                                    <input type="text" style="border-radius: 20px;" class="form-control form-control-sm" id="nro_documento" onchange="validateJS(event, 'nit')" name="nro_documento" aria-label="Small" aria-describedby="inputGroup-sizing-sm" required>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#precio_unitario_mayor_con_iva").on("keyup", function() {
            ...
            precio_unitario_mayor_sin_iva = parseFloat(precio_unitario_mayor_con_iva / (1 + ($(
        ...
        $('#id_tipo_afectacion_iva').on('change', function(e) {
            ...
            if (response) {
                ...
                precio_unitario_sin_iva = parseFloat($("#precio_unitario_con_iva").val() / (1 + ($(
                    "#impuesto_producto").val() / 100))).toFixed(2);
                $("#precio_unitario_sin_iva").val(precio_unitario_sin_iva);


                precio_unitario_mayor_sin_iva = parseFloat($("#precio_unitario_mayor_con_iva").val() / (1 +
                    ($("#impuesto_producto").val() / 100))).toFixed(2);
                $("#precio_unitario_mayor_sin_iva").val(precio_unitario_mayor_sin_iva);

                precio_unitario_oferta_sin_iva = parseFloat($("#precio_unitario_oferta_con_iva").val() / (
    ...
    *=========================================================================================================================================*/
    ...
    function fnc_CargarDataTableProductos() {
        ...
        $("#tbl_productos").DataTable({
            ...
            columnDefs: [
                ...
                // },
                {
                    targets: [1, 2, 4, 7, 8, 9, 10, 11, 13, 14, 15, 16, 17, 18, 21, 22, 23, 24,],
                    visible: false
                },
                {
                    targets: 0,
    ...
    function fnc_CargarSelects() {
        ...
        CargarSelect('4', $("#tipo_documento"), "--Seleccione Tipo Documento--", "ajax/ventas.ajax.php", 'obtener_tipo_documento', null, 0);
    ...
    function fnc_CargarDataTableListadoProductos() {
        ...
        $('#tbl_ListadoProductos').DataTable({
            ...
            "columns": [{
                ...
                {
                    "data": "cantidad_temp" //4
                },
                {
                    "data": "costo_unitario" //5
                },
                {
                    "data": "costo_unitario_temp" //6
                },
                {
                    "data": "descuento" //7
                },
                {
                    "data": "descuento_temp" //8
                },
                {
                    "data": "subTotal" //9
                },
                ...
                {
                    "data": "tipo_afectacion_iva" //12
                },
                {
                    "data": "factor_iva" //13
                },
                {
                    "data": "porcentaje_iva" //14
                }
            ],
            // "order": [
            //     [1, 'desc']
            ...
            success: function(respuesta) {
                ...
                if (respuesta) {
                    ...
                    $('#tbl_ListadoProductos').DataTable().row.add({
                        ...
                        'impuesto': 0,
                        'total': 0,
                        'tipo_afectacion_iva': respuesta["id_tipo_afectacion_iva"],
                        'factor_iva': respuesta["factor_iva"],
                        'porcentaje_iva': respuesta["porcentaje_iva"]
    ...
    *=========================================================================================================================================*/
    function fnc_ActualizarDatos() {
        ...
        $('#tbl_ListadoProductos').DataTable().rows().eq(0).each(function(index) {
            ...
            $factor_iva = data["factor_iva"]
            $porcentaje_iva = data["porcentaje_iva"]

            $subtotal = (($costo_unitario / $factor_iva) * $cantidad);
        ...
        $("#resumen_total_iva").html($("#simbolo_moneda").val() + ' ' + $total_impuesto.toFixed(2));
    ...
    *=========================================================================================================================================*/
    function fnc_GuardarCompra() {
        ...
        if ($("#forma_pago").val() == 2) {
            ...
            $("#total_compra").val($("#resumen_total_venta").html().replace('Q', ''));
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $total_iva = $("#resumen_total_iva").html().replace('Q ', '').trim();
                    $total_descuento = $("#resumen_total_descuento").html().replace('Q ', '').trim();
                    $total = $("#resumen_total_venta").html().replace('Q ', '').trim();
    ...
    function fnc_EditarCompra(data) {
        ...
        for (let index = 0; index < detalle_compra.length; index++) {
            ...
            $('#tbl_ListadoProductos').DataTable().row.add({
                ...
                'tipo_afectacion_iva': producto.id_tipo_afectacion_iva,
                'factor_iva': producto.factor_iva,
    ...
    *=========================================================================================================================================*/
    ...
    function fnc_AgregarCuotaCronograma() {
        ...
        let $saldo = 0;
        let $total_venta = parseFloat($("#resumen_total_venta").html().replace('Q', ''));
        let $importe = 0;
        let $nro_cuota = 1;
    ...
    function fnc_ConfirmarCronogramaCompra() {
        ...
        let $importe_cuota = 0;
        let $total_compra = parseFloat($("#resumen_total_venta").html().replace('Q', ''));
