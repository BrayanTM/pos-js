                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-2">
                            <label class="mb-0 ml-1 text-sm my-text-color"><i class="mr-1 my-text-color">Q.</i>Monto Apertura</label>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-6 mb-2">
                        <label class="mb-0 ml-1 text-sm my-text-color"><i class="mr-1 my-text-color">Q.</i>Monto Efectivo Real</label>
                    ...
                    <div class="col-6 mb-2">
                        <label class="mb-0 ml-1 text-sm my-text-color"><i class="mr-1 my-text-color">Q.</i>Monto Efectivo Caja</label>
                    ...
                    <div class="col-6 mb-2">
                        <label class="mb-0 ml-1 text-sm my-text-color"><i class="mr-1 my-text-color">Q.</i>Sobrante</label>
                    ...
                    <div class="col-6 mb-2">
                        <label class="mb-0 ml-1 text-sm my-text-color"><i class="mr-1 my-text-color">Q.</i>Faltante</label>
