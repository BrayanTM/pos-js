...
<script>
    ...
    function fnc_CargarDatosProducto($id_producto) {
        ...
        $("#id_tipo_afectacion_iva").val($producto.id_tipo_afectacion_iva).change();

        var formData = new FormData();
        formData.append('accion', 'obtener_impuesto_tipo_operacion')
        formData.append('id_tipo_afectacion', $producto.id_tipo_afectacion_iva);
        response = SolicitudAjax('ajax/productos.ajax.php', 'POST', formData);
        ...
        $("#precio_unitario_con_iva").val($producto.precio_unitario_con_iva);
        $("#precio_unitario_sin_iva").val($producto.precio_unitario_sin_iva);
        $("#precio_unitario_mayor_con_iva").val($producto.precio_unitario_mayor_con_iva);
        $("#precio_unitario_mayor_sin_iva").val($producto.precio_unitario_mayor_sin_iva);
        $("#precio_unitario_oferta_con_iva").val($producto.precio_unitario_oferta_con_iva);
        $("#precio_unitario_oferta_sin_iva").val($producto.precio_unitario_oferta_sin_iva);
