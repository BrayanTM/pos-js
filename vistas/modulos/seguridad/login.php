...
<head>
    ...
    <title>DISTRIBUIDORA LA GUADALUPANA | Login</title>
...
<body>
    ...
    <div class="container" style="background-image: url('vistas/assets/imagenes/fondo_login_2.jpg');  background-repeat: no-repeat;  background-position: 0% 0%;  background-size: 100% 100%;">

        <div class="forms-container">
            <div class="signin-signup">

                <form class="sign-in-form needs-validation-login" novalidate>
                    <h2 class="title" style="text-shadow: #0000; color: #ffff;">INICIAR SESION</h2>
                    ...
                    <a style="cursor: pointer;" class="fw-bold text-warning mt-2" id="btnReestablecerPassword">Restablecer Contraseña</a>
        ...
        <div class="panels-container">
            ...
            <div class="panel left-panel mt-4">
                <div class="content">
                    <h3>DISTRIBUIDORA LA GUADALUPANA</h3>
                    <p>
                        Inicio de Sesión
                    </p>
                    <!-- <img src="vistas/assets/dist/img/login.png" class="image" alt="Logo Login" /> -->
                </div>
            </div>
        </div>
