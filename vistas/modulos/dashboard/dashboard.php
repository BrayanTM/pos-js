            ...
            <div class="col-12">
                ...
                <div class="card card-gray shadow w-lg-100 float-right mt-4">
                    ...
                    <div class="card-body px-3 py-3 fw-bold" style="position: relative;">
                        ...
                        <span class="titulo-fieldset px-3 py-1" id="title-header-ventas-mes"> </span>
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="card card-gray shadow mt-4">
                    ...
                    <div class="card-body px-3 py-3" style="position: relative;">
                        ...
                        <span class="titulo-fieldset px-3 py-1">TOP VENTAS POR CATEGORÍAS </span>
            ...
            <div class="col-12 col-lg-6">
                ...
                <div class="card card-gray shadow mt-4">
                    ...
                    <div class="card-body px-3 py-3" style="position: relative;">
                        ...
                        <span class="titulo-fieldset px-3 py-1">FACTURAS / BOLETAS</span>
            ...
            <div class="col-lg-6">
                ...
                <div class="card card-gray shadow mt-4">
                    ...
                    <div class="card-body px-3 py-3" style="position: relative;">
                        ...
                        <span class="titulo-fieldset px-3 py-1">PRODUCTOS MAS VENDIDOS</span>
    ...
    function cargarGraficoBarras() {
        ...
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                $("#title-header-ventas-mes").html('VENTAS DEL MES: Q. ' + total_ventas_mes.toFixed(2).toString().replace(/\d(?=(\d{3})+\.)/g, "$&,"));
            ...
            success: function(respuesta) {
                ...
                for (let i = 0; i < respuesta.length; i++) {
                    filas = '<tr>' +
                        ...
                        '<td class="text-center"> Q.  ' + respuesta[i]["total_venta"] + '</td>' +
                        '</tr>'
