...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h2 class="m-0 fw-bold">REPORTE VENTAS PRODUCTOS MÁS VENDIDOS</h2>
            </div><!-- /.col -->
            <div class="col-sm-6  d-none d-md-block">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="index.php">Inicio</a></li>
                    <li class="breadcrumb-item active">Reporte Ventas Productos Más Vendidos</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    function fnc_CargarDataTableVentasProductos() {
        ...
        $("#tbl_ventas_productos").DataTable({
            ...
            buttons: [{
                extend: 'excel',
                title: function() {
                    var printTitle = 'REPORTE VENTAS PRODUCTOS MÁS VENDIDOS';
                    return printTitle
                }
            }, 'pageLength'],
            pageLength: 10,
            ...
            ajax: {
                ...
                data: {
                    'accion': 'reporte_ventas_productos_mas_vendidos'
                },
                type: 'POST'
            },
