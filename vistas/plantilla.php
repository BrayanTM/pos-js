...
if (isset($_GET["cerrar_sesion"]) && $_GET["cerrar_sesion"] == 1) {
    ...
    // echo '
    //         <script>
    //             window.location = "http://localhost/dist_guadalupana/";
    //         </script>        
    //     ';
}
...
<head>
    ...
    <title>DISTRIBUIDORA LA GUADALUPANA</title>

    <link rel="shortcut icon" href="vistas/assets/dist/img/logos_empresas/logo.jpg" type="image/x-icon">
