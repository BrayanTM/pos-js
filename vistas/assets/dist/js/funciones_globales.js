...
function validateJS(event, type) {
    ...
    if (type == "nit") {
        ...
        formData.append('accion', 'validar_nit');
        formData.append('id_proveedor',event.target.attributes['id_proveedor'].value);
        formData.append('nit', event.target.value);
        ...
        if(response['existe'] > 0){
            ...
            $(event.target).parent().children(".invalid-feedback").html("El NIT ya fue registrado");
    ...
    if (type == "nit_empresa") {
        ...
        formData.append('accion', 'validar_nit_empresa');
    ...
    if (type == "ubigeo") {
        ...
        if(event.target.value.length > 4){
            ...
            $(event.target).parent().children(".invalid-feedback").html("Ubigeo de 4 dígitos");
